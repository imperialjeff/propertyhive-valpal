...
class properthive_valpal_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'https://wp-property-hive.com/add-on-store/propertyhive-valpal-r62aam099/update-info.php',
		...
		if ( apply_filters( 'propertyhive_add_on_can_be_updated', false, 'propertyhive-valpal' ) === true )
	    {
